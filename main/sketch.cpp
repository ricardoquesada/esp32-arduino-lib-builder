...
//
// Instead of using "Serial" you can use Bluepad32 "Serial" class instead.
...
void dumpGamepad(ControllerPtr ctl) {
    Serial.printf(
        "idx=%d, dpad: 0x%02x, buttons: 0x%04x, axis L: %4ld, %4ld, axis R: %4ld, %4ld, brake: %4ld, throttle: %4ld, "
        "misc: 0x%02x, gyro x:%6ld y:%6ld z:%6ld, accel x:%6ld y:%6ld z:%6ld\n",
...
void dumpMouse(ControllerPtr ctl) {
    Serial.printf("idx=%d, buttons: 0x%04x, scrollWheel=0x%04x, delta X: %4ld, delta Y: %4ld\n",
                   ctl->index(),        // Controller Index
                   ctl->buttons(),      // bitmask of pressed buttons
